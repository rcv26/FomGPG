...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function enviarDatosAlServidor(datosFormulario) {
        ...
        if (!datosFormulario.registro || datosFormulario.registro.length === 0) {
            delete datosParaEnviar.registro;
        }
    
        if (!datosFormulario.servicios || datosFormulario.servicios.length === 0) {
            delete datosParaEnviar.servicios;
        }

        if (!datosFormulario.asociacion || datosFormulario.asociacion.length === 0) {
            delete datosParaEnviar.asociacion;
        }

        if (!datosFormulario.cargo || datosFormulario.cargo.length === 0) {
            delete datosParaEnviar.cargo;
        }

        if (!datosFormulario.evento || datosFormulario.evento.length === 0) {
            delete datosParaEnviar.evento;
        }

        if (!datosFormulario.tipoevento || datosFormulario.tipoevento.length === 0) {
            delete datosParaEnviar.tipoevento;
        }
